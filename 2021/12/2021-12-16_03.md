...
![](https://img1.d9tools.com/2021/12/2101.gif)

接着来做Delete功能，在`Post.razor`加入Delete按钮。

![](https://img1.d9tools.com/2021/12/2102.png)
...
![](https://img1.d9tools.com/2021/12/2103.png)

为了验证是否正确，删除原来`Post.razor`注释的Post.Id，加入新样式的Post.Id，可以看到没有问题。

![](https://img1.d9tools.com/2021/12/2104.png)
...
![](https://img1.d9tools.com/2021/12/2105.png)
...
![](https://img1.d9tools.com/2021/12/2110.png)

接着在`Blog.razor`的`<Post>`改用`GetPostIdForDelegate`。

![](https://img1.d9tools.com/2021/12/2111.png)
...
![](https://img1.d9tools.com/2021/12/2112.png)

另外委托一旦在子组件中定义了，父组件就必须要调用，否则会发生错误，EventCallback则没这问题。

![](https://img1.d9tools.com/2021/12/2113.png)

**站长注：当然，善于使用nullable也可以避免这种异常：**

![](https://img1.d9tools.com/2021/12/2114.png)
