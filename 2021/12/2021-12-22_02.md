...
![](https://lequ.co/2021/12/3201.png)

在`BlazorServer` 项目按右键，选择「`添加`」，选择「`新搭建基架的项目`」，切换到「`标识`」页签，选择`标识`。

![](https://lequ.co/2021/12/3202.png)

![](https://lequ.co/2021/12/3203.png)
...
![](https://lequ.co/2021/12/3210.gif)

注册界面填写正确的邮箱和密码，`AspNetUsers`表即可查看注册的用户信息：

![](https://lequ.co/2021/12/3211.png)
