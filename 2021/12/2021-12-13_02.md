...
![bootstrap下载icon页面1](https://lequ.co/2021/12/1401.png)

![bootstrap下载icon页面2](https://lequ.co/2021/12/1402.png)

![bootstrap下载icon页面2](https://lequ.co/2021/12/1403.png)

![bootstrap下载icon页面3](https://lequ.co/2021/12/1404.png)

![修改bootstrap类](https://lequ.co/2021/12/1405.png)

![bootstrap图标](https://lequ.co/2021/12/1406.png)

接着打开Blazor Server项目的`launchSettings.json`文件，在profiles内的BlazorServer输入这行"launchUrl": "Post"。

![](https://lequ.co/2021/12/1407.png)
...
![单向绑定](https://lequ.co/2021/12/1408.png)

双向绑定则要用`@bind-value`将input内的数据跟页面绑在一起，页面输入的内容也会反向影响数据。

![双向绑定](https://lequ.co/2021/12/1409.png)
...
![事件绑定](https://lequ.co/2021/12/1410.gif)
...
![格式绑定](https://lequ.co/2021/12/1411.png)
