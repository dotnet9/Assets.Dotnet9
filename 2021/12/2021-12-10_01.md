...
![创建解决](https://lequ.co/2021/12/0701.png)

![Blazor 两种模板应用](https://lequ.co/2021/12/0703.png)

![创建Blazor Server应用](https://lequ.co/2021/12/0702.png)

![配置Blazor Server应用](https://lequ.co/2021/12/0704.png)

![选择.NET 6](https://lequ.co/2021/12/0705.png)

![运行](https://lequ.co/2021/12/0706.png)

![运行+F12](https://lequ.co/2021/12/0707.png)

![F5重新加载网页](https://lequ.co/2021/12/0708.png)

![SignalR连接](https://lequ.co/2021/12/0709.png)
...
![清空文件下载记录](https://lequ.co/2021/12/0710.png)

![切换Counter和Fetch data菜单](https://lequ.co/2021/12/0711.gif)

接着在同一个解决方案建立一个Blazor WebAssembly项目，可以看到这里有 `渐进式 Web 应用程序` 选项，如果选了，这个网站就可以在电脑下载下来。

![同一解决方案新建项目](https://lequ.co/2021/12/0712.png)

![选择Blazor WebAssembly应用](https://lequ.co/2021/12/0713.png)

![Blazor WebAssembly应用其他信息配置](https://lequ.co/2021/12/0714.png)

项目建好后可以直接启动项目，但如果想同时看到Blazor Server跟Blazor WebAssembly都启动呢？可以将两个项目都设定为启动项目，接着按下F5启动项目。

![Blazor WebAssembly应用运行](https://lequ.co/2021/12/0715.png)

![解决方案配置启动项目菜单](https://lequ.co/2021/12/0716.png)

![配置多启动项目](https://lequ.co/2021/12/0717.png)

![多启动项目配置成功](https://lequ.co/2021/12/0718.png)
...
![两种模式运行下载文件对比](https://lequ.co/2021/12/0719.png)

接着来看项目结构，为求方便我将两者对等的文件用相同颜色框起来，并标上数字。先看5号，可以看到Blazor Server和Blazor WebAssembly有Program.cs，两者的程序进入点都是Program.cs。

![两种模式项目结构对比](https://lequ.co/2021/12/0720.png)

Blazor Server的Program.cs文件：

![Blazor Server Program.cs](https://lequ.co/2021/12/0721.png)

Blazor Wasm的Program.cs文件：

![Blazor Wasm Program.cs](https://lequ.co/2021/12/0722.png)
...
![Blazor Server Program.cs](https://lequ.co/2021/12/0723.png)

![Blazor Server _Host.cshtml_](https://lequ.co/2021/12/0724.png)
...
![Blazor Server Data目录](https://lequ.co/2021/12/0725.png)
