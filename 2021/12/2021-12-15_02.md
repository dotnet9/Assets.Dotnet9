...
![](https://lequ.co/2021/12/1801.png)

接着在`Blog.razor`用`<CascadingValue Value="ColorStyle">`将`<Post>`包住。

![](https://lequ.co/2021/12/1802.png)

再于PostBase.razor.cs定义同名变量，不过多了`[CascadingParameter]`attribute。

![](https://lequ.co/2021/12/1803.png)

然后只要在想要套用的地方填写该变量即可。

![](https://lequ.co/2021/12/1804.png)

`MyButton`也是一样的用法。

![](https://lequ.co/2021/12/1805.png)
...
![](https://lequ.co/2021/12/1806.png)

![](https://lequ.co/2021/12/1807.png)

**[站长注：上下有差异，上面是站长调试结果，下面是原文截图]**

![](https://lequ.co/2021/12/1808.png)
