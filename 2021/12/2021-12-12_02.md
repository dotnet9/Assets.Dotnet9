...
![原FetchData.razor](https://lequ.co/2021/12/1201.png)

提取C#代码后代码截图：

![提取C#代码后代码截图](https://lequ.co/2021/12/1202.png)

页面展示不变：

![页面展示不变](https://lequ.co/2021/12/1203.png)
...
![使用ComponentBase](https://lequ.co/2021/12/1204.png)
...
![删除多余组件等文件](https://lequ.co/2021/12/1205.png)
...
![PostBase](https://lequ.co/2021/12/1206.png)
...
![Input Component](https://lequ.co/2021/12/1207.png)
...
![Post页面展示](https://lequ.co/2021/12/1208.png)
...
![添加样式](https://lequ.co/2021/12/1209.png)
...
![添加验证](https://lequ.co/2021/12/1210.png)

![验证错误提示](https://lequ.co/2021/12/1211.png)
...
![自定义样式关联](https://lequ.co/2021/12/1212.png)

最后最重要的一步，在`Post.razor`将`EditForm`的`Model`参数移除，改为`EditContext`参数，里面的值就是刚刚的`EditContext`字段。

![替换Model为EditContext](https://lequ.co/2021/12/1213.png)
...
![定制的数据验证提示](https://lequ.co/2021/12/1214.png)
