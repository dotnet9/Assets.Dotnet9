...
![](https://img1.d9tools.com/2021/12/3308.png)

**站长.NET 6项目截图：和上面对比，少了一个OnGet()方法**

![](https://img1.d9tools.com/2021/12/3309.png)
...
![](https://img1.d9tools.com/2021/12/3310.png)
...
![](https://img1.d9tools.com/2021/12/3311.png)
...
![](https://img1.d9tools.com/2021/12/3312.png)

不过现在注销后还停留在`Log out`页面似乎没有意义，所以将`OnPost()`的else区块改成`return LocalRedirect("~/Blog");`，这样注销后就会回到未验证的`Blog` 页面。

![](https://img1.d9tools.com/2021/12/3313.png)

![](https://img1.d9tools.com/2021/12/3314.gif)
