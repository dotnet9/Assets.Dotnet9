...
![](https://img1.d9tools.com/2021/12/2201.png)
...
![](https://img1.d9tools.com/2021/12/2208.png)

![](https://img1.d9tools.com/2021/12/2209.png)
...
![](https://img1.d9tools.com/2021/12/2210.png)

![](https://img1.d9tools.com/2021/12/2211.png)

![](https://img1.d9tools.com/2021/12/2212.png)

再加入自己的`<script>`，这边比较特别的是用了`Promise`，Promise 是用来让异步更好用的语法，`resolve`的意思是执行成功后会回传的内容(这边执行成功的意思是没有异常，也就是不论按下确定还是取消都会回传)。

![](https://img1.d9tools.com/2021/12/2213.png)

`Confirm` 方法则改成调用刚定义好的`SweetConfirm()`。

![](https://img1.d9tools.com/2021/12/2214.png)
...
![](https://img1.d9tools.com/2021/12/2215.png)

如果点击取消，`willDelete` 是null。

![](https://img1.d9tools.com/2021/12/2216.png)
...
![](https://img1.d9tools.com/2021/12/2217.gif)
