...
![](https://lequ.co/2019/12/0201.png)
...
![](https://lequ.co/2019/12/0202.png)

本站单日IP访问量又突破新高，达到了500访问量，又上一个新台阶，谢谢广大网友。

![](https://lequ.co/2019/12/0203.png)

另外，亦是由于两篇文章大火，Dotnet9小编的个人博客站点出了点小插曲，以下是本站最新快讯：

![](https://lequ.co/2019/12/0204.png)
...
![](https://lequ.co/2019/12/0205.png)

### 2.3 黑色主题

![](https://lequ.co/2019/12/0206.png)
...
![](https://lequ.co/2019/12/0220.jpg)

#### 4.3.2ImageBlock

ImageBlock，图片块展示。

![](https://lequ.co/2019/12/0221.gif)

#### 4.3.3 FloatingBlock

FloatingBlock，看见这个控件想到了什么？是不是想到看直播时一直给主播点赞送小花的情景？

![](https://lequ.co/2019/12/0222.gif)

#### 4.3.4 RunningBlock

RunningBlock滚动块，跑马灯式效果，用于桌面软件打滚动广告还是很好的，如果你是做视频播放类软件，用于弹幕也是很方便的。

![](https://lequ.co/2019/12/0223.gif)
...
![](https://lequ.co/2019/12/0231.png)
...
![](https://lequ.co/2019/12/0239.gif)

#### 4.6.2 TimeBar

TimeBar时间条，可以扩展到自制甘特图使用。

![](https://lequ.co/2019/12/0240.gif)

#### 4.6.3 Calendar

Calendar日期控件，比较常规。

![](https://lequ.co/2019/12/0241.png)

#### 4.6.4 Clock

Clock时钟控件，也比较常规。

![](https://lequ.co/2019/12/0242.jpg)

#### 4.6.5 CalendarWithClock

CalendarWithClock日期与时钟组合控件，这个比较好，好用。

![](https://lequ.co/2019/12/0243.png)

#### 4.6.6 DatePicker

DatePicker日期选择控件，比较常用的控件。

![](https://lequ.co/2019/12/0244.jpg)

#### 4.6.7 TimePicker
TimePicker时间选择控件，也比较常用。

![](https://lequ.co/2019/12/0245.png)

#### 4.6.8 DateTimePicker

DateTimePicker日期时间选择控件，这个组合选择比较完美，小编以后的项目中有此场景，一定会尝试使用。

![](https://lequ.co/2019/12/0246.png)
...
![](https://lequ.co/2019/12/0253.png)
...
![](https://lequ.co/2019/12/0254.png)

#### 4.8.2 Brush

Brush画刷，提供28种常用画刷，业界良心呀，受用了。

![](https://lequ.co/2019/12/0255.png)

#### 4.8.3 SwitchConfig

SwitchConfig选择配置，常用于界面国际化语言选择，方便吧。

![](https://lequ.co/2019/12/0256.png)

#### 4.8.4 Expander

Expander，常规控件。

![](https://lequ.co/2019/12/0257.png)

#### 4.8.5GroupBox

GroupBox组合框，常规控件。

![](https://lequ.co/2019/12/0258.png)

#### 4.8.6 ScrollViewer

ScrollViewer滚动视图，也比较常用。

![](https://lequ.co/2019/12/0259.png)

#### 4.8.7  TransitioningContentControl

 TransitioningContentControl内容过渡控件，效果不错吧。

![](https://lequ.co/2019/12/0260.gif)

#### 4.8.8 TabControl1

TabControl1选项卡控件样式一。

![](https://lequ.co/2019/12/0261.gif)

#### 4.8.9 TabControl2

TabControl2选项卡控件样式二。

![](https://lequ.co/2019/12/0262.png)

#### 4.8.10 Drawer

Drawer，抽屉类布局控件，对空间有要求的业务场景很是有用。

![](https://lequ.co/2019/12/0263.gif)

#### 4.8.11 HoneycombPanel

HoneycombPanel蜂窝布局，有意思的布局控件。

![](https://lequ.co/2019/12/0264.png)

#### 4.8.12 Magnifier

Magnifier放大镜控件，京东、淘宝购物时，鼠标移动到物品图片上可以放大查看，很方便使用的控件。

![](https://lequ.co/2019/12/0265.gif)

#### 4.8.13 Card

![](https://lequ.co/2019/12/0266.png)

#### 4.8.14 Grid

Grid栅格布局。

![](https://lequ.co/2019/12/0267.gif)

#### 4.8.15 AnimationPath

AnimationPath动画路径，比较酷炫。

![](https://lequ.co/2019/12/0268.gif)

#### 4.8.16 Growl

Growl信息通知，有用的提示控件，比如做监控类软件，有重要信息报警时，信息通知可用在软件界面内弹出提示，也可在软件不在桌面最顶端时，直接在操作系统桌面弹出，非常灵活。

![](https://lequ.co/2019/12/0269.gif)

#### 4.8.17 GoToTop

![](https://lequ.co/2019/12/0270.gif)

#### 4.8.18 Transfer

Transfer穿梭框，多个列表项移动时着实有用。

![](https://lequ.co/2019/12/0271.png)

#### 4.8.19 CoverFlow

CoverFlow封面流，图片浏览的一种形式。

![](https://lequ.co/2019/12/0272.gif)

#### 4.8.20 CoverView

CoverView封面视图。

![](https://lequ.co/2019/12/0273.gif)

#### 4.8.21 Carousel

Carousel轮播，广告自动播放。

![](https://lequ.co/2019/12/0274.gif)

#### 4.8.22 CompareSlider-h

CompareSlider-h水平对比滑块。

![](https://lequ.co/2019/12/0275.gif)

#### 4.8.23 CompareSlider-v

CompareSlider-v竖直对比滑块。

![](https://lequ.co/2019/12/0276.gif)

#### 4.8.24 ImageBrowser

ImageBrowser，图片浏览控件，这个很强大了，通常展现图片以卡片的形式展现缩略图，当用户以为某图比较有用时，使用此控件查看很是方便，因为此控件录制的gif大于9MB，小编就不显示动图了，你们能够本身下载自行体验。

![](https://lequ.co/2019/12/0277.png)

#### 4.8.25 WaterfallPanel

WaterfallPanel瀑布流布局。

![](https://lequ.co/2019/12/0278.png)
...
![](https://lequ.co/2019/12/0283.gif)

#### 4.10.2 GifImage

GifImage，gif图片播放，微软目前也没有自带实现此功能，只能靠开源社区自己实现了，HC作者实现的不错，内存占用率较低。

![](https://lequ.co/2019/12/0284.gif)

### 4.11 数据展示类控件

#### 4.11.1 ListBox

![](https://lequ.co/2019/12/0285.png)

#### 4.11.2 ListView

![](https://lequ.co/2019/12/0286.png)

#### 4.11.3 TreeView

![](https://lequ.co/2019/12/0287.png)

#### 4.11.4 DataGrid

![](https://lequ.co/2019/12/0288.png)

#### 4.11.5 DarkTheme

![](https://lequ.co/2019/12/0289.png)
...
![](https://lequ.co/2019/12/0290.gif)

#### 4.12.2 Dialog

Dialog对话框，Web样式遮罩显示，可区分父窗体与应用程序主窗体遮罩，可灵活控制。

![](https://lequ.co/2019/12/0291.gif)

#### 4.12.3 MessageBox

![](https://lequ.co/2019/12/0292.png)

#### 4.12.4 ChatBubble

ChatBubble聊天气泡，做IM软件非常实用。

![](https://lequ.co/2019/12/0293.png)

以下是小编自己模拟与HC控件库作者之间的简短问候：

![](https://lequ.co/2019/12/0294.gif)
