...
slug: we-chat-automation-using-csharp-to-realize-we-chat-automation
description: "模拟鼠标来操作UI，实现UI自动化"
date: 2023-08-29 22:12:14
lastmod: 2023-08-29 22:12:14
author: 四处观察
...
接下来则是使用获取的进程 ID 和 Flaui 绑定起来，然后获取到微信的主 UI 界面，
