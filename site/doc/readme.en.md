...
More open-source projects can be found at: [https://github.com/dotnet9/](https://github.com/dotnet9/)

## Website

| Project | Description |
| --- | --- |
| [CodeWF](https://github.com/dotnet9/CodeWF) | Source code repository for `dotnet9.com` / `codewf.com` websites, based on ASP.NET Core Razor Pages. |
| [Assets.Dotnet9](https://github.com/dotnet9/Assets.Dotnet9) | File-based content repository for website articles, documentation, tool data, images, and site configuration. |

## C# Common

| Project | Description |
| --- | --- |
| [CodeWF.EventBus.Socket](https://github.com/dotnet9/CodeWF.EventBus.Socket) | Lightweight inter-process event bus based on TCP Socket, supporting publish-subscribe and Query/Response. |
| [CodeWF.EventBus](https://github.com/dotnet9/CodeWF.EventBus) | In-process event bus suitable for module decoupling and simple CQRS in desktop, web, and console projects. |
| [CodeWF.NetWeaver](https://github.com/dotnet9/CodeWF.NetWeaver) | Core library for network packet serialization, and provides a TCP/UDP wrapper layer `CodeWF.NetWrapper` based on it. |
