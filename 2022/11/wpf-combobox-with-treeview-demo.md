...
首先我是参考网友的实现方式：[WPF 之 Treeview 实现 MVVM 双向绑定](https://www.cnblogs.com/cplemom/p/12078859.html)
...
需要注意的是，将直接**绑定事件**切换到**通过 Command 绑定**的实现方式：
...
- 引用 MVVM 库，可以参考：[WPF MVVM 通用封装库](https://blog.csdn.net/qq_28149763/article/details/126358900)
