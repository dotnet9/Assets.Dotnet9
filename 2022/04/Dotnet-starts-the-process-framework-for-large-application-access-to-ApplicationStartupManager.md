---
title: .NET 为大型应用接入 ApplicationStartupManager 启动流程框架
slug: dotnet-starts-the-process-framework-for-large-application-access-to-application-startup-manager
description: "设想，用户双击了桌面图标，然而等待几分钟，应用才启动完毕，那用户下一步会不会就是点击卸载了。为了权衡大型应用软件在启动过程，既需要执行复杂的启动逻辑，又需要关注启动性能，为此过程造一个框架是一个完全合理的事情。"
date: 2022-04-10 08:38:46
lastmod: 2022-04-10 08:38:46
author: 林德熙
...
![](https://img1.dotnet9.com/2022/04/0701.jpg)
...
![](https://img1.dotnet9.com/2022/04/0702.jpg)
...
![](https://img1.dotnet9.com/2022/04/0703.jpg)
...
![](https://img1.dotnet9.com/2022/04/0704.jpg)
...
第一步使用 NuGet 安装 ApplicationStartupManager 库。如果项目使用 SDK 风格的项目文件格式，可以在 csproj 项目文件上添加如下的代码进行安装
...
![](https://img1.dotnet9.com/2022/04/0705.jpg)
...
![](https://img1.dotnet9.com/2022/04/0706.jpg)
...
![](https://img1.dotnet9.com/2022/04/0707.jpg)
