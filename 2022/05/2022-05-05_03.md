...
![](https://lequ.co/2022/05/1601.jpg)
...
![](https://lequ.co/2022/05/1602.png)
...
![文章配图-结构体.drawio](https://lequ.co/2022/05/1606.png)
...
![](https://lequ.co/2022/05/1607.png)

结构体定义的布局信息如下，可以看到每个结构体都是实际的数据存储，不包含额外的占用。

![](https://lequ.co/2022/05/1608.png)
...
![](https://lequ.co/2022/05/1609.png)
...
![](https://lequ.co/2022/05/1610.png)
...
![](https://lequ.co/2022/05/1611.png)
...
![](https://lequ.co/2022/05/1612.png)
...
![](https://lequ.co/2022/05/1613.png)
...
![](https://lequ.co/2022/05/1614.png)

那么同样是引用传递，使用类会更慢一些呢？这就要回到更加底层的CPU相关的知识了，我们CPU里面除了基本的计算单元以外，还有L1、L2、L3这些数据缓存，如下图所示。

![](https://lequ.co/2022/05/1615.png)

![](https://lequ.co/2022/05/1616.png)
...
![](https://lequ.co/2022/05/1617.png)

我们可以从上图看出，使用引用类型缓存未命中的次数最多，解引用的次数也很多，这些拖慢了性能。

如下图所示，顺序存储的结构体要比跳跃式的引用类型内存访问效率高。另外对象的体积越小，对于缓存就越友好。

![文章配图-类Cache.drawio](https://lequ.co/2022/05/1618.png)

![文章配图-结构体Cache.drawio](https://lequ.co/2022/05/1619.png)
