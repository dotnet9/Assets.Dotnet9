...
![](https://img1.d9tools.com/2022/02/0801.png)

## 安装MvvmLight插件

项目名称右键-->管理NuGet程序包-->搜索MvvmLight-->安装。如下所示：

![](https://img1.d9tools.com/2022/02/0802.png)

 弹出接受许可证窗口，点击【接受】如下所示：

![](https://img1.d9tools.com/2022/02/0803.png)

 MvvmLight安装成功后，自动引用需要的第三方库，并默认生成示例内容，有些不需要的需要删除，如下所示：

![](https://img1.d9tools.com/2022/02/0804.png)

## MVVM示例截图

主要通过MVVM实现数据的CRUD【增删改查】基础操作，如下所示：

![](https://img1.d9tools.com/2022/02/0805.gif)
...
![](https://img1.d9tools.com/2022/02/0806.png)